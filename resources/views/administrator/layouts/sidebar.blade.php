<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{ asset('administrator/users-profile.html') }}">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{ asset('administrator/pages-register.html') }}">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{ asset('administrator/pages-login.html') }}">
